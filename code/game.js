  ...
  for (var y = 0; y < this.height; y++) {
    ...
    for (var x = 0; x < this.width; x++) {
      ...
      // Because there is a third case (space ' '), use an "else if" instead of "else"
        ...
        fieldType = "goback";
      //to add smth that isn't moving
      //also remember if you add smth you gotta add associated methods so you'll have to have a constructor
...
var wobbleDist2 = 0.22, wobbleSpeed2 = 15;
...
var wobbleDist2 = 0.22, wobbleSpeed2 = 15;
Reset.prototype.act = function(step) {
	this.wobble += step * wobbleSpeed2;
	var wobblePos = Math.sin(this.wobble) * wobbleDist2;
	this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "lava" && this.status == null) {
    ...
    this.player.pos = new Vector(4, 14);
  }
  else if (type == "coin") {
